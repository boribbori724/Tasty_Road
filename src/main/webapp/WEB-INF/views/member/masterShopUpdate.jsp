...
<!-- 	</div> -->
	...
	<form action="masterShopUpdate.do" id="shopReg" method="post" enctype="multipart/form-data">
				...
				<div>
					...
					<span class="box int_name"> <input type="text" id="name"
						name="shopName" class="int" maxlength="20" required="required" value="${vo.shopName }">
					</span> 
				</div>
				...
				<div>
					...
					<span class="box int_mobile"> <input type="text" id="tel" name="shopNo"
						class="int" maxlength="16" placeholder="- 없이 숫자만 입력해주세요." required="required" value="${vo.shopNo }" readonly>
					</span> 
				</div>
				...
				<div>
					...
					<span class="box int_mobile"> <input type="text" id="tel" name="tel"
						class="int" maxlength="16" placeholder="- 없이 숫자만 입력해주세요." required="required" value="${vo.tel }">
					</span> 
				</div>
				...
				<div class="btn_area">
					<button id="btnJoin" onclick="location.href='/member/shopDelete.do?id=${vo.id}'">
						<span>기업 삭제</span>
					</button>
				</div>
